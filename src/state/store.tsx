  ...
  switch (action.type) {
    ...
    case "SWIPE": {
      ...
      if (rest.length < 3) {
        ...
        // the admin hid — unless rules say otherwise. ALSO: anything dealt in
        // the last 7 days waits its turn (deck memory); if that starves the
        // deck, recency relaxes first, never the hard filters.
